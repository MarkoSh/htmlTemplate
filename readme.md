...
<ol>
	...
	<li>All basic styles (html, body, fonts, buttons, etc...) placed in <strong>app/scss/_base.scss</strong>;</li>
	<li>In the file <strong>app/header.scss</strong> should be placed all styless, responsible for displaying the first screen (on the biggest screens) on all pages;</li>
